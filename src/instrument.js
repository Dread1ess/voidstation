...
export class InstrumentPanel {
    constructor(engine) {
        ...
        this._waveCtx = null;
        this._trimStartHandle = null;
        this._trimEndHandle = null;
        this._sampleFilename = null;
        this._sampleTrimInfo = null;
    ...
    _buildSampleSection() {
        ...
        fileInput.addEventListener('change', async () => {
            ...
            try {
                ...
                if (this._sampleFilename)
                    this._sampleFilename.textContent = 'could not load';
            }
            this.render();
        });
    ...
    _drawSample() {
        ...
        if (trimEl)
            trimEl.textContent = `${start.toFixed(2)} – ${end.toFixed(2)} s`;
        if (previewBtn)
